...
VALUES (
        ...
        NULL,
        NULL,
        'Canada Communicable Disease Report Vol 22-13, 1984 study at sea'
    ),
    (
        NULL,
        '2',
 ...
 ATTORNEYS AT LAW. 110 E LEXINGTON ST STE 100, BALTIMORE, MD 21202'
    ...
    (
        ...
        NULL,
        '27.05.1999',
        '(Yirmiyahu Zeev), s of Jeffrey, g of Leo, Jeremiasz''s family tree, twin of Evan Moshe'
    ),
    (
        '620',
        '623',
    ...
    (
        ...
        NULL,
        '. .1960?',
        'D of Sheldon, g of William, great-g of Morris, brothers Gary & Robert, ch Marissa & Joshua'
    ),
    (
        '889',
        '893',
        ...
        NULL,
        '17.01.1922',
        'R Jerome, m Dorothy Kowarsky, d 8.8.1999, s of Isidor, g of Jacob & Sarah Ritter, ch Stephen, Jody & Scott, member of New York Area Skeptics - lectured against alternative medicine & psychic surgery'
    ),
    (
        '890',
        '894',
        ...
        NULL,
        '18.06.1941',
        'R Everett, s of Sylvan (changed to William Ryan) & Elizabeth Couper, m Toni Eady (Toni re-m Clayton Chrisman), b of Patricia, Douglas, Robert & Ronald, d Sheryl Jeanette & Kathleen Elizabeth'
    ),
    (
        '891',
        '895',
        ...
        NULL,
        '?',
        'Steven''s brother, monitoring of plants, principal Investigator PAL/USEPA, 26 W MLK Dr, Cinti OH45219, Silbiger.Richard@epamail.epa.gov'
    ),
    (
        '892',
        '896',
        ...
        'Vulkan',
        '. .1878',
        'Daughter of Yisrael & Golda of Wieliczka-Klesno see Daniel Vulkan'
    ),
    (
        '893',
        '897',
        ...
        NULL,
        '26.05.1979',
        'Twin daughter of Adie Karnowski, granddaughter of Rabbi C B'
    ),
    (
        '894',
        '898',
        ...
        NULL,
        '19.09.1919',
        'B Moravska Ostrava, (Zvi/Bertel), son of Dr Joseph, m Rosa (Rosel) Strassberg, father of Daniel & Josef, d 12.12.1965 Tel-Aviv'
    ),
    (
        '895',
        '899',
        ...
        NULL,
        '29.12.1944',
        'R Gordon, s of Sylvan (changed to William Ryan) & Elizabeth Couper, b of Patricia, Richard, Douglas & Ronald, m Terri Le Altizer, s Mitchell Dean'
    ),
    (
        '896',
        '900',
        ...
        NULL,
        '. .1957?',
        'S of Reimund & Leah, g of Arthur, b Daniel & s Iris, Richard Hummel''s branch'
    ),
    (
        '897',
        '901',
        ...
        NULL,
        '. .1964?',
        'S of Sheldon, g of William, great-g of Morris, brother Gary & sister Rhonda, m April 2003'
    ),
    (
        '898',
        '902',
        ...
        NULL,
        '26.03.1970',
        'S of Alexander & Marianne, g of Adolf, gg of Hermann, Board 1995/96 (Karlsruhe) AIESEC, Germany, m Sarah in 1995 now 49 Ramona Ave #4, SF, CA94103'
    ),
    (
        '899',
        '903',
        ...
        NULL,
        '19.08.1926',
        'Born in Brazil, m. Aparecida Rachid, brother Herberto, sister Lily, son Reynaldo'
    ),
    (
        '900',
        '904',
        ...
        NULL,
        '. .1903?',
        'Daughter of Rabbi Chaim who went to Israel in 1935, m Zvi'
    ),
    (
        '901',
        '905',
        ...
        'Daum',
        '14.08.1914',
        'R Frimet, born Poland, sister of Rabbi C B, mother of Miriam Chane (born 19.7.1952), d May? 1999, the Krakow Ghetto Database'
    ),
    (
        '902',
        '906',
    ...
    (
        ...
        NULL,
        '?',
        'Krakow deaths, d 1875, Act 185, film 1895669'
    ),
    (
        '905',
        '909',
        ...
        NULL,
        '19.05.1951',
        'R James, s of Sylvan (changed to Ryan), b of Patricia, Richard, Douglas & Robert, m Margaret Mary Mohler (dob 12.4.1959), s Sean David (Dageforde), d Shawnna Christine,'
    ),
    (
        '906',
        '910',
        ...
        NULL,
        '12.05.1984',
        'D of Daniel, g of Zvi (Robert/Bertl), great-g of Dr Joseph'
    ),
    (
        '907 *',
        '910A',
    ...
    (
        ...
        'Marmor',
        '20.06.1886',
        'Jeremiasz''s granddaughter, d of Bernard (Berl), s of Ignatz'
    ),
    (
        '909',
        '912',
        ...
        'Silbiger',
        '1882?',
        'M Geza Silbiger, d Auschwitz July 1944'
    ),
    (
        '910',
        '913',
        ...
        'Herz',
        '. .189?',
        'Jeremiasz''s granddaughter, Mendel''s daughter, son Ferda (moved to Australia, m an actress, saved family photo)'
    ),
    (
        '911',
        '914',
    ...
    (
        ...
        NULL,
        '16.09.1884',
        'B Schott in Chzanow, per Detroit Holocaust Center, lived in Bedzin, Am Wasser 12'
    ),
    (
        'missing',
        '917',
        ...
        NULL,
        '?',
        'Buried in Bielsko Biala, died 1896'
    ),
    (
        '914',
        '918',
        ...
        NULL,
        '?',
        'Buried in Bielsko Biala, died 1937'
    ),
    (
        'missing',
        '919',
        ...
        NULL,
        '?',
        'Died in 1906 per Bielsko-Biala Register'
    ),
    (
        'missing',
        '920',
        ...
        NULL,
        '?',
        'Died in 1922 per Bielsko-Biala Register'
    ),
    (
        '915',
        '921',
        ...
        NULL,
        '. .1922',
        'D 10.8.1935, Piotrkow, province Katowice'
    ),
    (
        '916',
        '922',
        ...
        NULL,
        '23.11.1920',
        'D of Szymon, Oswiecim school report'
    ),
    (
        '917',
        '923',
        ...
        NULL,
        '. .1879',
        'D in Manhattan 26.2.1939 aged 60'
    ),
    (
        '918',
        '924',
        ...
        NULL,
        '. .1894',
        'B to Adolf, younger s Sadye Cecile m name Orlove, b Sol, Irvin & Jerome'
    ),
    (
        '919',
        '925',
        ...
        'Honig',
        '?',
        'B Krakow, per Museum of Holocaust in Washington, Auschwitz, Bergen-Belsen, Krakow, Plaszow'
    ),
    (
        '920',
        '926',
        ...
        'Lewis',
        '. .1925?',
        'D of Samuel (4th marriage), niece of Moritz, lived in St John''s Wood, London in 1972'
    ),
    (
        '921',
        '927',
        ...
        'Windmuller',
        '28.8.1921',
        'D of Moshe & Fanny Kleinmann, m Isaac, emigrated to Israel, lives in RaAana'
    ),
    (
        '922',
        '928',
        ...
        NULL,
        '08.08.1946',
        'Born in Brazil to Roberto and Aparecida Rachid, Reynaldo''s sister'
    ),
    (
        '923',
        '929',
        ...
        NULL,
        '13.09.1944',
        'D 2.4.1991, per SSDI, Maryland, mother of Courtney & Shannon (see Clifford)'
    ),
    (
        '924',
        '930',
    ...
    (
        ...
        NULL,
        '?',
        'R Geduldig, R Hummel''s cousin, born to Celia nee Silbiger'
    ),
    (
        '926',
        '932',
        ...
        'Englander',
        '. .1826',
        'M Mano b 1821, 6 children per 1869 Hungarian census of Szepes Megye'
    ),
    (
        '927',
        '933',
        ...
        'Chayes',
        '. .1885?',
        'M Manes v Emanuel in 1912, Tarnów, d of Julius (Juda) & Perla Rapaport'
    ),
    (
        'missing',
        '934',
        ...
        NULL,
        '?',
        'Died in 1931 per Bielsko-Biala Register'
    ),
    (
        '928',
        '935',
    ...
    (
        ...
        NULL,
        '. .1920',
        'B to Szymon per Oswiecim school records'
    ),
    (
        '930',
        '937',
        ...
        NULL,
        '?',
        'Krakow cemetery, section 11, row 45, grave 12, page 169, sort 48'
    ),
    (
        '931',
        '938',
        ...
        NULL,
        '. .1925?',
        'From the identity cards of Jews from Oswiecim, per Artur Szyndler'
    ),
    (
        '932',
        '939',
        ...
        NULL,
        '28.03.1910',
        'S of Julius & Johanna (2nd marriage), f of Theodor, Mirjam and Joseph, converted to catholic church, m Ludmilla Volkl (b 10.06.1914), g of Jochanan and Gabriel, b of Bruno, Irma, Hilde & Frieda, d Nov 1985 in Vienna'
    ),
    (
        '933',
        '940',
        ...
        NULL,
        '. .1912?',
        'S of Heinrich & Eliska Schnurer from Ostrava, brother of Alfred'
    ),
    (
        '934',
        '941',
    ...
    (
        ...
        'David',
        '22.07.1922',
        'M Eduard, s Eduard, Josef & Karl, d Ilse, lives in Nurnberg, d of Adolf & Anna Schnitzer, g of Hermann of Skotschau'
    ),
    (
        '936',
        '943',
        ...
        NULL,
        '20.04.1958',
        'R William (Russ), son of Herman, grandson of Edgar, 562 Ray Lane, Ashland, OR97520, silbiger@mind.net'
    ),
    (
        '937',
        '944',
        ...
        'Benson',
        '. .1928',
        'D of Arthur & Johanna, s of Reimund & Eva, g of Maximillian, s of Reimund & Eva (Vienna), lives in Hawaii'
    ),
    (
        '938',
        '945',
    ...
    (
        ...
        NULL,
        '?',
        'R.L., 1827 Bayshore Blvd, Tampa, FL33606-3210, the Internet'
    ),
    (
        '940',
        '947',
        ...
        'Osher',
        '. .1959?',
        'Daughter of Rabbi C B, married Yakov, children Yisroel, Moishe, Kreindy, Yocheved, Aidy, Naftoli, Henech, Yitschok, Yehudis, Zalmen Leib'
    ),
    (
        '941',
        '948',
        ...
        NULL,
        '?',
        'Krakow cemetery, section 3, row 2, grave 5, page 170, sort 16'
    ),
    (
        '942',
        '949',
        ...
        NULL,
        '12.05.1905',
        'D 29.07.1992, 33133 Miami, Miami-dade, Fl, per SSDI'
    ),
    (
        '943',
        '950',
        ...
        NULL,
        '. .1886',
        'Member of Bet Lechem fund (Krakow c 1924), the Krakow Ghetto Database'
    ),
    (
        '944',
        '951',
        ...
        'Wistreich',
        '?',
        'M Jakob in 1930, d of Szymon & Helena Eizen, lived in Krakow per act 887, fond 1010'
    ),
    (
        '945',
        '952',
        ...
        NULL,
        '15.02.1897',
        'D Oct 1983, 91335 Reseda, LA, CA, per SSDI'
    ),
    (
        '946',
        '953',
        ...
        'Silbiger',
        '?',
        'D of Enoch Wulkan per Artur Szyndler'
    ),
    (
        '947',
        '954',
        ...
        NULL,
        '?',
        'Houseowner with Wolf, Szymon and Ettel Bruche - Kazimierz, Kupa 10 per 1907 Krakow Directory'
    ),
    (
        '948',
        '955',
        ...
        NULL,
        '?',
        'D 8.9.1873 (adult), interred in the Jewish cemetery, Brno, page 57'
    ),
    (
        '949',
        '956',
    ...
    (
        ...
        NULL,
        '?',
        'Died in 1878 per Bielsko-Biala Register'
    ),
    (
        '950',
        '958',
        ...
        'Seelenfreund',
        '. .188?',
        'Jeremiasz''s granddaughter, Bernard''s daughter, son Icek married Pola'
    ),
    (
        '951',
        '959',
        ...
        NULL,
        '25.02.1911',
        'S. (Schayndl), Jeremiasz''s granddaughter, Jakub & Gusta Unger''s daughter'
    ),
    (
        '952',
        '960',
        ...
        'Wiener',
        '09.11.1897',
        'D of Fradel Silbiger & Chiel Majer Wiener'
    ),
    (
        '953',
        '961',
        ...
        NULL,
        '?',
        'S Joseph, Swiss account?, Eleanor Hart''s info'
    ),
    (
        '954',
        '962',
        ...
        NULL,
        '. .1845?',
        'M Sali Krieger (b 21.7.1849 d 28.10.1906), ch Adolf, Josef, Henrietta, Berta, Klara, Josefina, Marie, Moric'
    ),
    (
        '955',
        '963',
        ...
        NULL,
        '. .1850?',
        'M Certla, s Samuel r Rybner? (m Marjem in 1906)'
    ),
    (
        '956',
        '964',
        ...
        NULL,
        '27.08.1863',
        'M. Anna Friedner/Panzer (b 13.4.1873 - 8.9.1941), s Fritz Siegfried who emigrated to Brazil, Moritz & d Charlotta, d 15.3.1933 Ostrava'
    ),
    (
        '957',
        '965',
        ...
        NULL,
        '. .1876',
        'M Perla Lieblich in 1902, Klasno, b to Izrael & Golda Zimmert, d Marya Alexandrowicz'
    ),
    (
        '958',
        '966',
        ...
        NULL,
        '?',
        'Restaurateur, Augustyanska 13, per Krakow Directory 1907'
    ),
    (
        '959',
        '967',
        ...
        NULL,
        '?',
        'Merchant, Krakowska 1, per Krakow Directory 1907'
    ),
    (
        '960',
        '968',
    ...
    (
        ...
        NULL,
        '. .1890?',
        'M Frymet Libenheimer in 1914, Chrzanów, s of Abraham & Ruchla Goldberg'
    ),
    (
        '962',
        '970',
        ...
        NULL,
        '. .1901',
        'S of Juda & Sala Wulkan per Jacek in the Auschwitz museum'
    ),
    (
        '963',
        '971',
        ...
        NULL,
        '?',
        'Krakow cemetery, section 11, row 45, grave 47, page 163, sort 43'
    ),
    (
        '964',
        '972',
        ...
        NULL,
        '25.03.1918',
        'Died at birth Piotrkow, province Katowice'
    ),
    (
        '965',
        '973',
        ...
        NULL,
        '. .1850?',
        'M Maria Rosbach, d Pesla (b 1877 in Chrzanow)'
    ),
    (
        '966',
        '974',
        ...
        NULL,
        '16.06.1880',
        'S of Jacob & Sarah Ritter, m Adeline (Ida) Breden, attorney from Columbia Law School, d 6.3.1974, d Edith Johnson (s Eddie) & Grace, b of Isidor, Harold, Anne, Paulina, Diana, helped Norbert to USA'
    ),
    (
        '967',
        '975',
        ...
        NULL,
        '. .1880?',
        'S Silbiger r Rybner?, m Marjem Flaumenhaft in 1906, Oswiecim, b to Salomon & Certla'
    ),
    (
        '968',
        '976',
    ...
    (
        ...
        NULL,
        '. .1895?',
        'F of Rose Lewis (4th marriage), brother of Moritz, both of Northern Hungary'
    ),
    (
        '970',
        '978',
        ...
        NULL,
        '?',
        '& Margot, 1263 Hopkins Ter NE, Atlanta, GA30324-3823, the Internet'
    ),
    (
        '971',
        '979',
    ...
    (
        ...
        NULL,
        '. .1907',
        'B in Bielsko Biala (to Joseph & Henrietta nee Getreider), d 1996 in Tel Aviv, father of Itta Davidson, brother Jacob (Kuba)'
    ),
    (
        '973',
        '982',
        ...
        NULL,
        '19.12.1914',
        'Dr, son of Dr Joseph, brother of Robert (Zvi), pediatrician in Israel, d 1984 Haifa, 2 sons (incl Oded), 1 daughter'
    ),
    (
        '974',
        '983',
    ...
    (
        ...
        'Windholtz',
        '10.12.1879',
        'M Mojzesz, d of Chaim & Mindel Feiler, d Szaja (b 15.7.1900)'
    ),
    (
        '976',
        '985',
        ...
        NULL,
        '?',
        'Krakow cemetery, section 6, row 5, grave 10, page 169, sort 22'
    ),
    (
        '977',
        '986',
        ...
        NULL,
        '08.11.1978',
        'Leo''s granddaughter, born to Eva & Paul Klenoff'
    ),
    (
        '978',
        '987',
        ...
        NULL,
        '?',
        'D of Steve & Janis Rubin, brother Seth'
    ),
    (
        '979',
        '988',
    ...
    (
        ...
        NULL,
        '10.04.1975',
        'D of Morry & Naomi, g of Emil & Gisela, s of Rachel'
    ),
    (
        '981',
        '990',
        ...
        'Herndorf',
        '. .1909?',
        'D of Chaim, moved to Israel in 1932, s of Yoav, Dora, Shlomo, Rachel & Yosef'
    ),
    (
        '982',
        '991',
        ...
        NULL,
        '29.03.1912',
        'D 20.041999, 33435 Boynton Beach, Palm Beach, FL, per SSDI'
    ),
    (
        '983',
        '992',
        ...
        NULL,
        '?',
        '2501 N Taylor Rd Apt 303, Cleveland, OH44118-1391, the Internet'
    ),
    (
        '984',
        '993',
        ...
        NULL,
        '. .1852',
        'Arrived in NY 06.08.1884 from Le Havre on Labrador'
    ),
    (
        '985',
        '994',
    ...
    (
        ...
        NULL,
        '?',
        'Died in 1915 per Bielsko-Biala Register'
    ),
    (
        '986',
        '996',
        ...
        NULL,
        '?',
        'S. Menachem, d. 1934, Zanz, father of Awrohom Chaim and son of Jisroel Jakir who d. 1891'
    ),
    (
        '987',
        '997',
    ...
    (
        ...
        NULL,
        '25.08.1897',
        'B in Oswiecim per Artur Szyndler'
    ),
    (
        '989',
        '999',
        ...
        NULL,
        '. .1897',
        'Died 1942, grandfather of Elimelech of Manchester, eldest brother of Adam Ringer''s mother'
    ),
    (
        '990',
        '1000',
        ...
        NULL,
        '25.01.1962',
        '21520 Burbank Blvd., #301, Woodland Hills, CA 91367-7062, b Stephen, s Jody, s of Richard Jerome & Dorothy Kowarsky. d. 21.11.2017'
    ),
    (
        '991',
        '1001',
        ...
        NULL,
        '20.09.1970',
        'S David Dageforde, s of Ronald & Margaret Mary, g Sylvan changed name to Ryan, sister Shawnna Christine, m Stacee Lynn'
    ),
    (
        '992',
        '1002',
    ...
    (
        ...
        NULL,
        '?',
        'S of Steve & Janis Rubin, sister Sara, Silver Spring MD'
    ),
    (
        '994',
        '1004',
        ...
        NULL,
        '. .1975',
        'D of Clifford & Roslyn, lives in Alexandria,VA, has a sister Courtney, son Jonah (b Jan 1997?)'
    ),
    (
        '995',
        '1005',
        ...
        NULL,
        '?',
        'Dr, 77 7th Ave Apt 21K New York, NY10011-6644, m Alan, last name is still Silbiger'
    ),
    (
        '996',
        '1006',
        ...
        'Gaynor',
        '26.02.1980',
        'S. Haddassah, Nossen''s daughter, Rabbi S''s granddaughter'
    ),
    (
        '997',
        '1007',
        ...
        NULL,
        '03.08.1997',
        'Elimelech''s daughter, granddaughter of Rabbi C B, m Schneck 5.1.1999'
    ),
    (
        '998',
        '1008',
        ...
        NULL,
        '?',
        '& Sabina, ch Barry Dov & Ari, s of Joseph (b 1910 in Oswiecim), 230 Crafton Ave, Staten Island, NY10314-4227, b of Julius'
    ),
    (
        '999',
        '1009',
        ...
        NULL,
        '?',
        '15326 W Tranquility Lake Dr, Delray Beach, FL33446-3473, the Internet'
    ),
    (
        '1000',
        '1010',
        ...
        NULL,
        '19.05.1932',
        'F of Gary, Rhonda & Robert, m Arline Blaire, great-g of Karl, g of Morris, s of William, lives in Akron, Ohio'
    ),
    (
        '1001',
        '1011',
        ...
        NULL,
        '15.05.1967',
        'S Jeanette, d of Richard & Toni Eady (Toni re-m Clayton Chrisman), sister Kathleen, g Sylvan changed name to Ryan'
    ),
    (
        '1002',
        '1012',
        ...
        NULL,
        '?',
        'M Sarah Fleisner, s Jindrich (b 1.11.1892), per Libuse Salomonovicova'
    ),
    (
        '1003',
        '1013',
        ...
        NULL,
        '. .1900?',
        'S of Nossen, youngest b of Avrohom (Nuremberg), Chaim Yitzchok (Janzur), Yehudo (Munich) & Shlomo Alter'
    ),
    (
        '1004',
        '1014',
        ...
        NULL,
        '. .1900?',
        'Son of Chaim who went to Israel 1935'
    ),
    (
        '1005',
        '1015',
    ...
    (
        ...
        NULL,
        '24.03.1904',
        'Mrs., d 27.8.1978,buried Warrensville Cemetery, per Cleveland obituary database of 8.Sep 1978, 44124 Cleveland Cuyahoga, OH, per SSDI'
    ),
    (
        '1007',
        '1017',
        ...
        NULL,
        '. .1972?',
        'S Yehudo, m Gitle Schloss 23.2.2000, parents Avrohom & Rikki, grandfather Rabbi C B of Manchester'
    ),
    (
        '1008',
        '1018',
        ...
        NULL,
        '15.11.1980',
        'S. Binyomin, m Itty Lichter on 26.8.1999 in New York, Elimelech''s son, grandson of Rabbi C B'
    ),
    (
        '1009',
        '1019',
        ...
        NULL,
        '. .1840?',
        'Father of Yehudo b 1866, grandfather of Chaim (Canada) & Yehoshua Pinchas (Jerusalem)'
    ),
    (
        '1010',
        '1020',
        ...
        NULL,
        '. .1890?',
        'S Zalmen, Nossen''s nephew, uncle of Rabbi C B, sons Elimelech Zimet & Aharon'
    ),
    (
        '1011',
        '1021',
        ...
        NULL,
        '. .1898?',
        'S Alter, Nossen''s son, b of Avrohom(Nuremberg), Chaim Yitzchok (Janzur), Yehuda (Munich) & Shimon, Rabbi C B''s uncle, m. Necha, father of Yaakov Dovid, Moshe, Dov Beresh, Yosef Shmuel, Zvi Eliezer & Rachka'
    ),
    (
        '1012',
        '1022',
        ...
        NULL,
        '. .1906?',
        'S of Chaim, went to Israel 1932, b of Yoav, Dora, Sarah, Rachel & Yosef'
    ),
    (
        '1013',
        '1023',
        ...
        NULL,
        '. .1987?',
        'S Benyomin, parents Avrohom & Rikki, grandfather Rabbi C B of Manchester'
    ),
    (
        '1014',
        '1024',
        ...
        NULL,
        '08.02.1989',
        'Nossen''s daughter, Rabbi S''s granddaughter'
    ),
    (
        '1015',
        '1025',
        ...
        NULL,
        '25.02.1981',
        'S Christine, d of Ronald & Margaret Mary, g of Sylvan who changed surname to Ryan, b Sean'
    ),
    (
        '1016',
        '1026',
        ...
        NULL,
        '24.12.1889',
        'D of Maurice, b in Godziszow, per Janusz Spyra, Margit''s sister?'
    ),
    (
        '1017',
        '1027',
        ...
        NULL,
        '?',
        'Buried in Bielsko Biala in 1924'
    ),
    (
        'missing',
        '1028',
        ...
        NULL,
        '?',
        'Died in 1895 per Bielsko-Biala Register'
    ),
    (
        'missing',
        '1029',
        ...
        NULL,
        '?',
        'Died in 1911 per Bielsko-Biala Register'
    ),
    (
        '1018',
        '1030',
    ...
    (
        ...
        NULL,
        '18.09.1908',
        'M Edita (Dr b 4.3.1915), s of Moric & Gizela Langer, Dr, d 15.12.1943 Auschwitz'
    ),
    (
        '1020',
        '1032',
        ...
        NULL,
        '31.10.1885',
        '(Zygfryd), re Swiss account, died in the Holocaust per Jacek Proszyk, Eleanor Hart''s tree?'
    ),
    (
        '1021',
        '1033',
        ...
        NULL,
        '?',
        'Zionist Organization in 1905. Elected twice to the Tarnow City Council. Instrumental in building a railroad from Tarnow to Dombrova.'
    ),
    (
        '1022',
        '1034',
        ...
        NULL,
        '. .1878',
        'Ellis Island on-line, arrived 1921 from Heilbronn, Germany (see Betty, Irma, Olga & Willy)'
    ),
    (
        '2023',
        '1035',
        ...
        NULL,
        '. .1857',
        'D 25.3.1889, m Augusta Wolf (b 1862 rem Holzgrunn), ch Vilém, Lev & Julius'
    ),
    (
        '1024',
        '1036',
        ...
        NULL,
        '16.12.1859',
        'M Julie Loewi (b 31.4.1867), d 25.4.1931, ch Selma, Samuel, Ervin, Arnold, Josefina & Elsa per L Salomonovicova'
    ),
    (
        '1025',
        '1037',
        ...
        NULL,
        '05.05.1872',
        'D 06.03.1932 per Libuse Salomonovicova'
    ),
    (
        '1026',
        '1038',
        ...
        NULL,
        '. .1878',
        'Ellis Island on-line, arrived 1908 from Fuerth, Germany (see Ernestine & Karl)'
    ),
    (
        '1027',
        '1039',
        ...
        NULL,
        '. .1890?',
        'S of Hermann & Henriette Krieger, b of Adolf, Bernhard, Anna & Regine'
    ),
    (
        '1028',
        '1040',
    ...
    (
        ...
        NULL,
        '28.05.1894',
        'Transport 5.6.1942 from Vienna to Izbica per Austrian Victims of the Holocaust'
    ),
    (
        '1030',
        '1042',
        ...
        NULL,
        '. .1840?',
        'Mohel on the birth cert. of Joachim Beer Grunspan, the son of Hinde'
    ),
    (
        '1031',
        '1043',
        ...
        NULL,
        '. .1880?',
        'B. Krakow, son of Menachem Mendel, father of Edward who married Mila Rosner (she was b April 1904)'
    ),
    (
        '1032',
        '1044',
        ...
        NULL,
        '15.03.1881',
        'B Oswiecim per Detroit Holocaust Center, lived in Bedzin, Burgstr 61'
    ),
    (
        '1033',
        '1045',
        ...
        NULL,
        '. .1890?',
        'Uncle of Rabbi C B, father of Moritz, Josef and also 2 daughters'
    ),
    (
        '1034',
        '1046',
        ...
        NULL,
        '. .1917',
        'Tailor from Hungary, rescued by Reszo Kasztner, the Internet'
    ),
    (
        '1035',
        '1047',
        ...
        NULL,
        '.10.1949',
        'S of Dr Samuel (Erich) & Victoria nee Arbib from Libya, m Rachel, 2 daughters Liat & Osnat, son Itai, brother Oded'
    ),
    (
        '1036',
        '1048',
    ...
    (
        ...
        NULL,
        '?',
        'Died in 1921 per Bielsko-Biala Register'
    ),
    (
        'missing',
        '1051',
        ...
        NULL,
        '?',
        'Died in 1885 per Bielsko-Biala Register'
    ),
    (
        '1038',
        '1052',
        ...
        NULL,
        '16.11.1899',
        'D Apr 1968, 21215 Baltimore City, MD, per SSDI, s of Adolf, s Rose & Sadye Cecile (m Orlove) & b Irvin & Jerome, s Arnold (lawyer)'
    ),
    (
        '1039',
        '1053',
        ...
        NULL,
        '?',
        '& Temie, 1815 50th St, Brooklyn, NY11204-1257, the Internet'
    ),
    (
        '1040',
        '1054',
        ...
        'Herndorf',
        '. .1902?',
        'Daughter of Rabbi Chaim who went to Israel in 1935'
    ),
    (
        '1041',
        '1055',
        ...
        NULL,
        '. .1970?',
        'Parents Avrohom & Rikki, grandfather Rabbi C B of Manchester, children Shloime Yoel & Chane Raisy'
    ),
    (
        '1042',
        '1056',
        ...
        'Zagdanski',
        '. .1930?',
        'Daughter of Eduard and Mila, lives in Upper Nazareth'
    ),
    (
        '1043',
        '1057',
        ...
        NULL,
        '?',
        'Krakow deaths, d 1887, Act 398, film 1895667'
    ),
    (
        '1044',
        '1058',
        ...
        NULL,
        '26.09.1967',
        'Mirek''s son, grandfather Bruno changed surname to Siba'
    ),
    (
        '1045',
        '1059',
        ...
        NULL,
        '31.12.1946',
        'S Alan MD, State University of NY-Upstate, Syracuse (1972), s of Richard J & Dorothy Kowarsky, s by 1st wife Louise Brodowski: Aaron & Adam, adopted d Emily (S Korea), s Jody, b Scott, re-m Gail Perry'
    ),
    (
        '1046',
        '1060',
        ...
        NULL,
        '?',
        '& Janis Rubin, 1939 Westchester Dr, Wheaton, MD20902-3564, the Internet, d Sara, s Seth'
    ),
    (
        '1047',
        '1061',
        ...
        NULL,
        '1912?',
        '11796 Indian Ridge Rd, Reston, VA 2209-3527, the Internet, s of Geza & Rosa, ch Ferenc & Djula, g Eitan & Nenad'
    ),
    (
        '1048',
        '1062',
        ...
        NULL,
        '?',
        '127 Meeting House Ln, Plymouth Meeting,PA19462-1801, the Internet'
    ),
    (
        '1049',
        '1063',
        ...
        NULL,
        '10.02.1966',
        '24526 Park St, Torrance, CA90505-6558, (Toyota), s of Dean Lewis & Joan Young (Yanovitz) b 28.2.1937, b of Eric (osteopath)'
    ),
    (
        '1050',
        '1064',
        ...
        'Rübner',
        '. .1885?',
        'D of Juda & Jetta, m Salomon in 1909, Klucznikowice ad. Oswiecim'
    ),
    (
        '1051',
        '1065',
        ...
        NULL,
        '18.06.1906',
        'D 9.9.1997, 33141 Miami, Miami-dade, FL, per SSDI'
    ),
    (
        '1052',
        '1066',
        ...
        NULL,
        '. .1855',
        'US 1870 census, see Franklin & Mary A'
    ),
    (
        '1053',
        '1067',
        ...
        'Holroyd',
        '23.01.1963',
        'D of Gilbert, m Robert E Jr, s Robby (1992) & d Jensen (1994)'
    ),
    (
        '1054',
        '1068',
        ...
        'Press',
        '. .1967',
        'S (ZC), m Sam, d of Julius, g of Joseph (Yosef Shmuel, b 1910 in Oswiecim)'
    ),
    (
        '1055',
        '1069',
        ...
        NULL,
        '?',
        'Krakow deaths, d 1876, Act 162, film 1201163'
    ),
    (
        '1056',
        '1070',
        ...
        NULL,
        '?',
        'Krakow deaths, d 1883, Act 287, film 1895666'
    ),
    (
        '1057',
        '1071',
        ...
        NULL,
        '10.07.1880',
        'Daughter of Abraham & Sara Machauf of Sidzina, LDS Family History Center, b Dawid, s Marya & Szymon'
    ),
    (
        '1058',
        '1072',
        ...
        'Bester (Berter?)',
        '. .1870?',
        'M Aron, d Lane - Reizel (m Alter - Hirsch Leidner, 1921)'
    ),
    (
        '1059',
        '1073',
        ...
        NULL,
        '. .1957',
        'D of Alfred & Marianne Foller, g of Karl & Gizella Lebkovitz, 50 Glenwood Rd Apt 235,Greenville, SC29615-1731, the Internet, Richard Hummel''s branch'
    ),
    (
        '1060',
        '1074',
        ...
        NULL,
        '21.05.1912',
        'D July 1983, 90019 LA,CA per SSDI'
    ),
    (
        '1061',
        '1075',
        ...
        NULL,
        '?',
        'B Krakow, per Museum of Holocaust in Washington'
    ),
    (
        '1062',
        '1076',
        ...
        NULL,
        '16.12.1910',
        'S of Harold, changed name to William S Ryan, m Elizabeth Anne Couper, d Patricia, s Richard, Douglas, Robert & Ron, Scott''s 2nd cousins'
    ),
    (
        '1063',
        '1077',
        ...
        NULL,
        '?',
        'Mentioned in the Oswiecim state archive of 1905 per Artur Szyndler'
    ),
    (
        '1064',
        '1078',
        ...
        'Ringer',
        '. .1855',
        'S. Natti, died 1899, buried in Oswiecim, daughter of Dow'
    ),
    (
        '1065',
        '1079',
        ...
        NULL,
        '?',
        'M Zimel Windholz who d 1869 & b in Oswiecim'
    ),
    (
        '1066',
        '1080',
    ...
    (
        ...
        NULL,
        '. .1883',
        'Krakow births Acts 258 & 362, film 1895665'
    ),
    (
        '1068',
        '1082',
        ...
        NULL,
        '10.04.1884',
        'S of Mendel & Brucha Klipper, m Roza Gelbwachs (b 2.4.1882) in 1909, f of Karol Edward, g of Stefa Zagdanski, d 4.6.1942, Houseowner with Sale, Wolf and Ettel Bruche - Kazimierz, Kupa 10 per 1907 Krakow Directory'
    ),
    (
        '1069',
        '1083',
        ...
        NULL,
        '05.07.1884',
        'S Israel, b Wieliczka, d 17.1.1942 per Auschwitz death book'
    ),
    (
        '1070',
        '1084',
        ...
        NULL,
        '. .188',
        'Krakow births, Act 199, film 1895667'
    ),
    (
        '1071',
        '1085',
        ...
        NULL,
        '. .1890?',
        'D Rozalia per Oswiecim school records, lived in Jagiellonska Street, also mentioned in the Oswiecim state archive per Artur Szyndler'
    ),
    (
        '1072',
        '1086',
    ...
    (
        ...
        NULL,
        '?',
        'S of Berek(?) & Pelia Ringer, f of Dora Ziv, g of Shimon'
    ),
    (
        '1074',
        '1088',
        ...
        NULL,
        '?',
        'Member of Bet Lechem fund (Krakow c 1925 & donor 1928 to 1931 zl37), member of Wysoka Shul 1887'
    ),
    (
        '1075',
        '1089',
        ...
        NULL,
        '?',
        'Houseowner with Sale, Wolf and Ettel Bruche - Kazimierz, Kupa 10 per 1907 Krakow Directory'
    ),
    (
        '1076',
        '1090',
        ...
        NULL,
        '27.04.1883',
        'S of Abraham & Sara Machauf, b of Dawid, Sussel & Marya, m Helena Eisen 1908, m Helena Brenner 1908, Krakow'
    ),
    (
        '1077',
        '1091',
        ...
        NULL,
        '. .1905?',
        'S of Pinkus & Chaja Obstfeld, Pradnik, m Anna-Berta Frühauf in 1929'
    ),
    (
        '1078',
        '1092',
    ...
    (
        ...
        'Pavlickova',
        '15.10.1948',
        'Daughter of Bruno who changed his surname to Siba'
    ),
    (
        '1081',
        '1095',
        ...
        NULL,
        '. . 1986',
        'Honig-Silbiger, d of Gary & Barbara Honig, b Karlo, member of The Sholem Community of Los Angeles, Nude fashion designer'
    ),
    (
        '1082',
        '1096',
        ...
        NULL,
        '?',
        'Tara & Ari Dinner/Journal, Young israel of West Hempstead, the Internet'
    ),
    (
        '1083',
        '1097',
        ...
        'Ancelle',
        '. .1937?',
        'D of Jacob, g of Joseph Yehuda & Henrietta Getreider, Itta davidson''s tree, lives in Paris'
    ),
    (
        '1084',
        '1098',
    ...
    (
        ...
        NULL,
        '. .1984',
        'B in Israel, she graduated from the Hayman Brand Hebrew Academy in Kansas.'
    ),
    (
        '1086',
        '1100',
        ...
        'Marmor',
        '. .189?',
        'Taylor Zilbiger, a student on the Freshman Program at the Rothberg International School, participated in the'
    ),
    (
        '1087',
        '1101',
        ...
        NULL,
        '?',
        'International Bible Quiz (Chidon Hatanach Haolami) this year. She attended a two-week camp from April 27 to'
    ),
    (
        '1088',
        '1102',
        ...
        NULL,
        '. .1910?',
        'May 13, 2003, along with the other participants from around the world. Zilbiger, 19, who was born in Israel,'
    ),
    (
        '1089',
        '1103',
        ...
        NULL,
        '04.05.1935',
        'graduated from the Hayman Brand Hebrew Academy in Kansas.'
    ),
    (
        'missing',
        '1103A',
        ...
        NULL,
        '04.05.1935',
        's of Rudolf & Ludmilla (Völkl), g of Julius, gg of Ignatz, brother of Joseph & Mirjam, father of Gabriel, Jochanan and Michal, returned from Israel, now lives in Vienna'
    ),
    (
        '1090',
        '1104',
        ...
        NULL,
        '22.09.1903',
        'D May 1975, 44112 Cleveland, Cuyahoga, OH, per SSDI'
    ),
    (
        '1091',
        '1105',
        ...
        NULL,
        '. .1936',
        'Son of Koert & Regina, grandson of Wilhelm, m Sara Singman 1962, partner in a NY law firm, children Andrew & Allegra'
    ),
    (
        '1092',
        '1106',
        ...
        NULL,
        '?',
        'Rr 9d, Garrison, NY10524, the Internet'
    ),
    (
        '1093',
        '1107',
        ...
        NULL,
        '07.10.1990',
        'Son of Jacob, grandson of Benyamin, lives in Israel'
    ),
    (
        '1094',
        '1108',
        ...
        'Weiss',
        '28.09.1973',
        'T Soroh, d of Adie Karnowsky, gd of Rabbi C B, m Levi Y 11.8.93, children Schloime 21.2.95, Shneur Zalman 2.10.96, Menachem Aryeh 12.8.98'
    ),
    (
        '1095',
        '1109',
        ...
        NULL,
        '14.04.1981',
        'Prefers her middle name Faigy, daughter of Adie Karnowsky, granddaughter of Rabbi C B'
    ),
    (
        '1096',
        '1110',
        ...
        NULL,
        '?',
        'U S, Kaiserin-Augusta-Allee 93, 10589 Berlin'
    ),
    (
        '1097',
        '1111',
        ...
        NULL,
        '. .1984',
        'S of Joseph, g of Zvi (Robert/Berl), great-g of Dr Joseph'
    ),
    (
        '1098',
        '1112',
        ...
        NULL,
        '?',
        'Buried in Bielsko Biala, died 1933'
    ),
    (
        '1099',
        '1113',
        ...
        NULL,
        '?',
        'UK 1999/2000 Liberal Democrat election per Internet'
    ),
    (
        '1100',
        '1114',
        ...
        'Ray',
        '10.12.1932',
        'Daughter of Heinrich who changed his surname to Silvan'
    ),
    (
        '1101',
        '1115',
        ...
        'Bartram',
        '. .1955?',
        'Daughter of Aharon & Ahuva, Los Angeles, 2 brothers & parents live in Israel'
    ),
    (
        '1102',
        '1116',
    ...
    (
        ...
        NULL,
        '05.10.1880',
        'S of Sigmund & Augusta Wolf, m Regina Gutherz (b 24.3.1881), d Eliska (b 2.12.1902) & Bedriska (b 19.9.1904)'
    ),
    (
        '1104',
        '1118',
        ...
        NULL,
        '12.12.1891',
        'Single per Libuse Salomonovicova of Ostrava'
    ),
    (
        '1105',
        '1119',
        ...
        NULL,
        '. .1888',
        'S of Moritz, b of Margit, Zofie, Cecilie, Arnost (Ernest) & Zigmund, m Maria, daughter (H)elena'
    ),
    (
        '1106',
        '1120',
    ...
    (
        ...
        NULL,
        '18.09.1908',
        'Dr, transport Prague to Terezin 8 July 1943, to Oswiecim 15.12.1943 per Lukas Pribyl'
    ),
    (
        '1108',
        '1122',
        ...
        NULL,
        '12.10.1983',
        'Born in Brazil to Reynaldo and Helcy Nogueira, Lara''s sister'
    ),
    (
        '1109',
        '1123',
        ...
        NULL,
        '?',
        '6140 Peters Rd, Plantation, FL33317-4601, the Internet'
    ),
    (
        '1110',
        '1124',
        ...
        NULL,
        '. .189?',
        'B of Willie, cousin of Maurice (& wife Ernestine Dombrowsky), came to England 1932, s Ralph & Clive, g Graham, Ian & Jane'
    ),
    (
        '1111',
        '1125',
        ...
        NULL,
        '?',
        'W. Elizabeth, 1827 Bayshore Blvd, Tampa,FL 33606-3210, the Internet'
    ),
    (
        '1112',
        '1126',
    ...
    (
        ...
        NULL,
        '. .1880?',
        'D 1958, son of Jacob, g of Herman R, lived in Bielitz, m Sabina Soldinger, 3 brothers Otto, Erwin & Hugo, s Edgar & Koert, Oswiecim state archive 1925'
    ),
    (
        '1114',
        '1128',
    ...
    (
        ...
        NULL,
        '02.12.1902',
        'D 2.12.1993 91367 Woodlands Hills, LA, CA per SSDI'
    ),
    (
        '1116',
        '1130',
        ...
        NULL,
        '14.11.1904',
        'D Mar 1977 44118 Cleveland, Cuyahoga, OH per SSDI'
    ),
    (
        '1117',
        '1131',
        ...
        NULL,
        '. .1906?',
        'M Jean, s of Morris & Larry, g of Karl, Sheldon''s father'
    ),
    (
        '1118',
        '1132',
    ...
    (
        ...
        NULL,
        '. .189?',
        'B of Walter, cousin of Maurice (& wife Ernestine Dombrowsky), came to England 1932'
    ),
    (
        '1120',
        '1134',
        ...
        NULL,
        '. .1905',
        'Ellis Island on-line, arrived 1921 from Heilbronn, Germany (see Betty, Irma, Olga & Siegmund)'
    ),
    (
        '1121',
        '1135',
        ...
        NULL,
        '?',
        'Krakow cemetery, section 17, row 10, grave 48, page 156, sort 88'
    ),
    (
        '1122',
        '1136',
